    ...
    <div className={styles.modal}>
      ...
      <div className={styles.modalMenus}>
        ...
        >
          ...
          <span className={styles.modalMenuText}>Grammar</span>
        </Link>
        <hr />
        {/* Logout button */}
        <button id={styles.modalMenu} onClick={hideModal}>
          <div
            id={styles.modalLogout}
            onClick={onLogOutClick}
            className='rounded-lg transition shadow-gray-500/50 shadow-md ease-in-out delay-50 bg-gray-400 hover:-translate-y-1 hover:bg-gray-300 duration-300'
          >
            Log Out
          </div>
        </button>
