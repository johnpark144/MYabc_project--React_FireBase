  ...
  return (
    <>
      <div className={styles.modal}>
        <div
          id={styles.modalContents}
          className='shadow-lg rounded-2xl p-4 bg-white w-64 m-auto'
        >
          <div className='w-full h-full text-center'>
            <div className='flex h-full flex-col justify-between'>
              ...
              <p className='text-gray-600 text-m py-2 px-6'>
              ...
              <div className='flex items-center justify-between gap-4 w-full h-1 mt-8'>
                <button
                  onClick={_delete}
                  disabled={lastDay.length === 0 || lastDay === 0}
                  type='button'
